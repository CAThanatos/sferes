...
system "Rscript RScriptBehaviourIterExp2.R $nbFiles $dossier $min $max";


sub printHelp()
{
	print "Usage : ./execRScriptBehaviourIterExp2.perl -d Directory [-n NumberOfFiles] [-min IterMin] [-max IterMax] [-h]\n";
