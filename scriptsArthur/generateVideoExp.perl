...
foreach my $file (@files)
{
	...
	if(-d $subDir)
	{
		if($file =~ /^$prefix/)
		{
			...
			print "$abs_dir/generateVideo.perl -d $subDir -m $morph -e $delay -r $rate -q $quality -o $output\n";
			system "$abs_dir/generateVideo.perl -d $subDir -m $morph -e $delay -r $rate -q $quality -o $output";
		}
	}
}
