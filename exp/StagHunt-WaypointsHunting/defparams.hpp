...
struct Params
{
	...
	{
#ifdef MAP800
		SFERES_STRING(map_name, SFERES_ROOT "/exp/StagHunt-WaypointsHunting/map800x800.pbm");
		static const float real_w = 2400.0f;
#elif defined(MAP1600)
		SFERES_STRING(map_name, SFERES_ROOT "/exp/StagHunt-WaypointsHunting/map1600x1600.pbm");
		static const float real_w = 4800.0f;
#elif defined(MAP2400)
		SFERES_STRING(map_name, SFERES_ROOT "/exp/StagHunt-WaypointsHunting/map2400x2400.pbm");
...
#elif defined(WAYPOINTS6)
		static const int nb_waypoints = 6;
#elif defined(NO_WAYPOINTS)
		static const int nb_waypoints = 0;
#else
		static const int nb_waypoints = 12;
#endif
	...
	static const float ratio_big_stags = 0;
		...
		static const float coeff_hunting = 10;

		static const float coeff_waypoints = 1;
	};
