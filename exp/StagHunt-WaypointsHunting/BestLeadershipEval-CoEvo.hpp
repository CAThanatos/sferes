    ...
    public:
				...
				void refresh(const E& ea)
      {
        ...
        this->_create_log_file_leadership_co(ea, "bestleadership-co.dat");
          ...
          float proportion_leader_waypoints_first = _best->nb_leader_waypoints_first()/_best->nb_preys_killed_coop();
          ...
          (*this->_log_file_leadership_co) << "," << _best_co->proportion_leader_preys();
          proportion_leader_preys_first = _best_co->nb_leader_preys_first()/_best_co->nb_preys_killed_coop();
          (*this->_log_file_leadership_co) << "," << proportion_leader_preys_first;
          (*this->_log_file_leadership_co) << "," << _best_co->nb_leader_preys_first() << "," << _best_co->nb_preys_killed_coop();

          (*this->_log_file_leadership_co) << "," << _best_co->proportion_leader_waypoints();
          proportion_leader_waypoints_first = _best_co->nb_leader_waypoints_first()/_best_co->nb_preys_killed_coop();
          (*this->_log_file_leadership_co) << "," << proportion_leader_waypoints_first;
          (*this->_log_file_leadership_co) << "," << _best_co->nb_leader_waypoints_first() << "," << _best_co->nb_preys_killed_coop() << "," << std::endl;
				}
      }
