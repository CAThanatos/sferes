...
#endif
    {
    	float rand1 = misc::rand(0.0f, 500.0f);
    	float rand2 = misc::rand(0.0f, 500.0f);

     	ind1.set_nb_hares(ind2.pop_pos(), rand1/50, rand1/50);
     	ind1.set_nb_sstags(ind2.pop_pos(), 0, 0);
     	ind1.set_nb_bstags(ind2.pop_pos(), 0, 0);

     	ind2.set_nb_hares(ind1.pop_pos(), rand2/50, rand2/50);
     	ind2.set_nb_sstags(ind1.pop_pos(), 0, 0);
     	ind2.set_nb_bstags(ind1.pop_pos(), 0, 0);
